...
// ErrObjectTooLarge is returned when too much data was read from stdin. current limit 5m
var ErrObjectTooLarge = errors.New("input object was too large. limit is 5mbytes")

const inputLimit = 5 * 1024 * 1024
